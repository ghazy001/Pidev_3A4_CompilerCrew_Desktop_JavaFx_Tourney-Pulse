...
import static controller.DisplayEquipeController.*;
/*
*
   Author: @Ghazi saoudi
*
...
public class UpdateEquipeController implements Initializable {
    ...
    Date Selcdate = DisplayEquipeController.selectedDate;
    String SelcNom = DisplayEquipeController.selectedNom;
    String Selcimage = DisplayEquipeController.selectedImage;

    static int Selcid = DisplayEquipeController.selectedId;
